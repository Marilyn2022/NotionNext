...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'f42e202b633d4a9fa1cb2eb4fe583219',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '关注最新AIGC产品使用教程、电脑黑科技工具、手机实用工具、电视影音工具🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '神器精选', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '关注最新AIGC产品使用教程、电脑黑科技工具、手机实用工具、电视影音工具🎉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'ttps://www.205066.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '神器精选, 博客', // 网站关键词 英文逗号隔开
...
//  FACEBOOK_APP_ID: process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || '', // Facebook App ID 來啟用 messenger 聊天功能 获取: https://developers.facebook.com/
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '神器精选', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '黑科技工具大全', // 站点描述，被notion中的页面描述覆盖
